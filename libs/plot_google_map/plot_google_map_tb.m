...
%     style = ['&style=feature:water|element:geometry.fill|hue:0x0800ff|saturation:-5|weight:0.1|lightness:0&style=feature:road|element:geometry|hue:0xff0000|lightness:-100|weight:0.2&style=element:labels|visibility:off'];
%     style = ['maptype=roadmap&style=element:labels%7Cvisibility:off&style=feature:administrative%7Cvisibility:off&style=feature:administrative.land_parcel%7Cvisibility:off&style=feature:administrative.neighborhood%7Cvisibility:off&style=feature:landscape.man_made%7Ccolor:0xd8d8d8%7Cvisibility:on&style=feature:landscape.natural%7Cvisibility:off&style=feature:poi%7Cvisibility:off&style=feature:water%7Ccolor:0xc0c0c0'];
%     style = ['maptype=roadmap&style=element:labels%7Cvisibility:off&style=feature:administrative%7Cvisibility:off&style=feature:administrative.land_parcel%7Cvisibility:off&style=feature:administrative.neighborhood%7Cvisibility:off&style=feature:landscape.man_made%7Ccolor:0xd3d3d3%7Cvisibility:on&style=feature:landscape.natural%7Ccolor:0xdfdfd7%7Cvisibility:on&style=feature:poi%7Cvisibility:off&style=feature:road%7Celement:labels%7Cvisibility:off&style=feature:road.arterial%7Ccolor:0xffffff&style=feature:road.local%7Ccolor:0xffffff&style=feature:transit.line%7Cvisibility:off&style=feature:transit.line%7Celement:geometry.stroke%7Cvisibility:off&style=feature:transit.line%7Celement:labels.icon%7Cvisibility:off&style=feature:transit.station.rail%7Celement:geometry%7Cvisibility:on&style=feature:water%7Ccolor:0xc0c0c0'];
    style = ['maptype=roadmap&style=element:labels%7Cvisibility:off&style=feature:administrative%7Cvisibility:off&style=feature:administrative.land_parcel%7Cvisibility:off&style=feature:administrative.neighborhood%7Cvisibility:off&style=feature:landscape%7Csaturation:-100&style=feature:landscape.man_made%7Ccolor:0xd3d3d3%7Cvisibility:on&style=feature:landscape.natural.landcover%7Ccolor:0xdfdfd7&style=feature:landscape.natural.terrain%7Csaturation:-25%7Cvisibility:on&style=feature:poi%7Cvisibility:off&style=feature:road%7Celement:labels%7Cvisibility:off&style=feature:road.arterial%7Ccolor:0xffffff&style=feature:road.local%7Ccolor:0xffffff&style=feature:transit.line%7Cvisibility:off&style=feature:transit.line%7Celement:geometry.stroke%7Cvisibility:off&style=feature:transit.line%7Celement:labels.icon%7Cvisibility:off&style=feature:transit.station.rail%7Celement:geometry%7Cvisibility:on&style=feature:water%7Ccolor:0x8d8d8d'];
end
...
if nargout <= 1 % plot map
    ...
    cax = caxis;
    if bw == 1
    uniImag(:,:,1) = uniImag(:,:,1) + uniImag(:,:,2) + uniImag(:,:,3);      %%TW
    uniImag = uniImag./max(uniImag(:));                                     %%TW
    uniImag(:,:,2) = uniImag(:,:,1);                                        %%TW
    uniImag(:,:,3) = uniImag(:,:,1);                                        %%TW
    end
